...
public class MainActivity extends AppCompatActivity {
    ...
    public void cekSpinner() {
        if (spinner.getSelectedItem().toString().equals("xxxhdpi")) {
            hitung(4.0);
        } else if (spinner.getSelectedItem().toString().equals("xxhdpi")) {
            hitung(3.0);
    ...
    public void hitung(double x) {
        TextView widthXxxhdpi, widthXxhdpi, widthXhdpi, widthHdpi, widthMdpi, widthLdpi, heightXxxhdpi, heightXxhdpi, heightXhdpi, heightHdpi, heightMdpi, heightLdpi;
        ...
        widthXxxhdpi = (TextView) findViewById(R.id.width_xxxhdpi);
        widthXxxhdpi.setText("width\t:\t" + (w0 / x) * 4);
        heightXxxhdpi = (TextView) findViewById(R.id.height_xxxhdpi);
        heightXxxhdpi.setText("height\t:\t" + (h0 / x) * 4);
